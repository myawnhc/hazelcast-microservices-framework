 ...
 * {@code @ConditionalOnMissingBean} safety-net skips creating the {@link SimpleVectorStoreService}.
 *
 * <p>If this module is not on the classpath (i.e., community build without {@code -Penterprise}),
 * the core configuration creates a {@link SimpleVectorStoreService} fallback (IMap-based
