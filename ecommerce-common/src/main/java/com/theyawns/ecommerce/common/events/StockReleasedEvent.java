 ...
 * </ul>
 *
 * <p>This is the compensating event for {@link StockReservedEvent} in the
 * Order Fulfillment saga. It undoes step 1 (stock reservation).
 *
...
public class StockReleasedEvent extends DomainEvent<Product, String>
    ...
    /**
     * Returns step 1 - compensates the StockReserved step.
     *
     * @return 1 (compensates second step)
     */
    @Override
    ...
    /**
     * StockReleasedEvent is a compensation event that undoes StockReserved.
     *
     * @return true
     */
    @Override
